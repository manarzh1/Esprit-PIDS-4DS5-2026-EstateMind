...
import { XAIEmergencePanel } from "@/components/XAIMarketPanel";
import {
        ...
        <div style={{
          ...
          <div style={{ display:"flex", alignItems:"center", gap:6, marginTop:10 }}>
            ...
            <span style={{ fontSize:10, color:"var(--mut)" }}>
              ...
              <XAIEmergencePanel
                city={alert.zone}
                medianPrice={alert.median_price_recent ?? Math.round(2500 * (1 + (alert.price_growth ?? 0) / 100))}
                volume={alert.n_listings_recent || 30}
              />
  );
}
